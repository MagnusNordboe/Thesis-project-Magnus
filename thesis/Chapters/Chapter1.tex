...
To research these questions, a way to generate realistic metric data about a microservice system was needed. 
...
\item \keyword{Feature}: A unique Prometheus metric that expresses some kind of information about the system as a number. Collected at fixed intervals to form an MTS.
